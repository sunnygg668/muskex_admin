...
abstract class BaseController
{
    ...
    public function __construct(protected App $app)
    {
        ...
        $this->request->header('Access-Control-Allow-Origin', '*'); // 允许所有域名跨域
        $this->request->header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS'); // 允许的请求方法
        $this->request->header('Access-Control-Allow-Headers: Authorization, Content-Type, X-Requested-With, ba-user-token');
